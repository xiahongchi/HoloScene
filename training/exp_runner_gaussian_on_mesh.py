...
from training.holoscene_train_gaussian import HoloSceneTrainGaussianRunner
import datetime
...
if __name__ == '__main__':
    ...
    # torch.distributed.init_process_group(backend='nccl', init_method='tcp://localhost:30000', world_size=world_size, rank=rank, timeout=datetime.timedelta(1, 1800))
    # torch.distributed.barrier()


    trainrunner = HoloSceneTrainGaussianRunner(conf=opt.conf,
