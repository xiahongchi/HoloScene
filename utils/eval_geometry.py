...
def calc_3d_metric(mesh_rec, mesh_gt):
    """
    ...
    # print(accuracy_rec, completion_rec, precision_ratio_rec, completion_ratio_rec, fscore, normal_acc, normal_comp,
    #       normal_avg)

    cd = (accuracy_rec + completion_rec) / 2
    print("accuracy_rec: ", accuracy_rec)
    print("completion_rec: ", completion_rec)
    print("cd_avg: ", cd)
    print("precision_ratio_rec: ", precision_ratio_rec)
    print("completion_ratio_rec: ", completion_ratio_rec)
    print("fscore: ", fscore)
    print("normal_acc: ", normal_acc)
    print("normal_comp: ", normal_comp)
    print("normal_avg: ", normal_avg)
